...
async function initSolicitudesTab() {
  try {
    // Reutilizar contexto ya cargado por pg-docs.js
    ...
    // Playground: solo omar.orozco@gmail.com
    if (_solUser.email !== 'omar.orozco@gmail.com') return
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // En infodoc/playground la inicialización es lazy (al hacer click en el tab)
  if (['infodoc', 'playground'].includes(document.body.dataset.page)) return
  initSolicitudes()
})
